...
namespace Polish.NumbersInWords.NumberInWordsProviders.ComplexNumbers.Cardinal
{
    internal class MasculineAccusative : IMasculineAccusative
    {
        ...
        private readonly ISingularMasculineAccusative _accusative;
        ...
        public MasculineAccusative(ICardinalNumberProviderFactory cardinalNumberSolverFactory,
                                   ISingularMasculineAccusative accusative,
                                   ...
                                   IPluralGenitive pluralGenitive)
        {
            ...
            _accusative = accusative ?? throw new System.ArgumentNullException(nameof(accusative));
